...
<body>
    ...
    <section class="breadcrumbbar">
        <div class="container">
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active"><a href="khoa_ngon_ngu_anh.php">Khoa quản trị kinh doanh</a></li>
            </ol>
        </div>
    </section>
    ...
    <section class="banner">
        <div class="container">
            <a href="sach-moi-tuyen-chon.html"><img src="images/khoaQTKD.png" alt="banner-sach-ktkn"
                    class="img-fluid"></a>
        </div>
    </section>
    <!-- khối sản phẩm  -->
                                               ...
                                               $sql="SELECT * 
                                                ...
                                                ;?>
                                                 <div class="col-lg-3 col-md-4 col-xs-6 item DeanGraziosi">
                                                      <div class="card ">
                                                    <img class="card-img-top anh" src="images/KhoaQTKD/<?php echo $row['anh'];?>" alt="">
